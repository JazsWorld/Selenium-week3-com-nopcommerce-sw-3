...
public class ElectronicsTest extends Utility {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.id("FirstName"), "Jagruti");
        sendTextToElement(By.id("LastName"), "Jadeja");
        sendTextToElement(By.id("Email"), emailID);
        selectByValueFromDropDown(By.name("DateOfBirthDay"), "22");
        selectByValueFromDropDown(By.name("DateOfBirthMonth"), "9");
        selectByValueFromDropDown(By.name("DateOfBirthYear"), "1988");
        sendTextToElement(By.id("Password"), "jagruti@556");
        sendTextToElement(By.id("ConfirmPassword"), "jagruti@556");
        ...
        Thread.sleep(2000);
        // Fill the Mandatory fields
        selectByValueFromDropDown(By.id("BillingNewAddress_CountryId"), "145");
        sendTextToElement(By.id("BillingNewAddress_City"), "vadodara");
        sendTextToElement(By.id("BillingNewAddress_Address1"), "a 5/8 ");
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "390018");
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "07554318256");
        // Click on “CONTINUE”
        ...
        Thread.sleep(2000);
        sendTextToElement(By.id("CardholderName"), "jagruti jadeja");
