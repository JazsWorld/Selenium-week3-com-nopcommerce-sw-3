...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        //2.22 Fill the all mandatory field
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Jagruti");
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Jagruti");
        sendTextToElement(By.id("BillingNewAddress_Email"), "jagrutijadeja1717@gmail50.com");
        sendTextToElement(By.id("BillingNewAddress_Company"), "Ja123@45");
        ...
        sendTextToElement(By.id("BillingNewAddress_FaxNumber"), "1234446");
